...
GUIDE_TEXT = [
    ...
    ["買 / 賣", "買/賣 股票 股數 金額　例：買 台積電 100 85000"],
    ["買 / 賣（只給金額）", "不打股數也可以　例：買 2330 50000"],
    ["　・買", "依收盤價估算股數"],
    ["　・賣", "賣掉全部持股；要賣部分請打股數，例：賣 2330 30 18000"],
    ["配息", "配息 股票 金額　例：配息 0050 3000元"],
    ["配股", "配股 股票 股數　例：配股 0056 100股"],
...
GUIDE_TITLE_ROW = 0
GUIDE_HEADING_ROWS = [2, 7, 16, 22, 28]
